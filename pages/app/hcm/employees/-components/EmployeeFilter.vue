...
export default {
  ...
  setup(props) {
    ...
    const handleFilter = (filterType) => {
      ...
      store.sortEmployeesList(filterType);
    };
    return {
      showFilters,
      toggleFilter,
...
<template>
  <div class="relative flex-shrink-0">
    ...
    <div
      v-if="showFilters"
      class="absolute left-0 z-30 mt-2 w-56 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
      role="menu"
