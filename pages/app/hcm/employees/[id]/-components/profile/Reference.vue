...
<template>
  <div class="mx-auto max-w-5xl px-4 pb-12 sm:px-6 lg:px-8">
    ...
    <div class="overflow-hidden bg-white pt-2 sm:rounded-md">
      <div
        role="list"
      ...
      >
        <div
          ...
          :key="list.id"
          @click="editReference(list)"
          class="col-span-1 cursor-pointer divide-y divide-gray-200 rounded-lg border bg-white shadow"
        >
    ...
    <div class="ml-4 mt-2 flex justify-end">
      <button
        ...
        v-if="reference.length >= 1 && !toogleForm"
        @click="tooggleFormAction"
      >
        <svg
          class="h-5 w-5"
