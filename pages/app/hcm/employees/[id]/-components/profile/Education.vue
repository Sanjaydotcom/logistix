...
export default {
  ...
  methods: {
    ...
    async editEducation(list) {
      this.toogleForm = !this.toogleForm;
      this.editData = list;
    },
    async deleteEducation() {
      this.toggleDeleteConfirmation();
      this.employeesStore.deleteEducation(this.id, this.selectedEducationId.value);
    },
  },
};
</script>
...
<template>
  <div class="mx-auto max-w-5xl px-4 pb-12 sm:px-6 lg:px-8">
    ...
    <div class="bg-white px-4 py-5 sm:px-6">
      ...
      >
        <div class="mt-2">
          <h2 class="text-md font-medium text-gray-500">Education</h2>
        </div>
      </div>
    </div>
    <button
      v-if="!educations.length && !toogleForm"
      type="button"
    ...
    <div
     ...
     >
      <ul role="list" class="divide-y divide-gray-200">
        <li v-for="list in educations" :key="list.university">
          <a class="block hover:bg-gray-50">
            <div class="flex items-center px-4 py-4 sm:px-6">
              ...
              <div class="ml-5 flex flex-shrink-0">
                ...
                <div @click="editEducation(list)" class="cursor-pointer px-2">
                  <svg
                ...
                <div @click="toggleDeleteConfirmation(list.id)" class="cursor-pointer">
    ...
    <div class="ml-4 mt-2 flex justify-end py-2">
      <button
        ...
        v-if="educations.length >= 1 && !toogleForm"
        @click="tooggleFormAction"
      >
        <svg
          class="h-5 w-5"
