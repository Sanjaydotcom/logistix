<script>
import KycAddEditSlider from "./KycAddEditSlider.vue";
    ...
    <div class="overflow-hidden bg-white sm:rounded-lg">
      ...
      <div class="border-gray-200 px-4 pb-5 sm:px-6">
        <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
          ...
          <div class="sm:col-span-1" v-if="general.licenceName">
            <dt class="text-sm font-medium text-gray-500">Licence Name</dt>
            <dd class="mt-1 text-sm text-gray-900">
              {{ general.licenceName }}
            </dd>
          </div>

          <div class="sm:col-span-1" v-if="general.licenceNo">
