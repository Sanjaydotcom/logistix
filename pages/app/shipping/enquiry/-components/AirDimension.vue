...
export default {
  ...
  setup(props) {
    ...
    const cal = (item) => {
      ...
      totalChargeableWeight.value =
        totalChargeableWeight.value + parseFloat(item.chargeableWeight);
    };
    ...
    const edit = (id) => {
      ...
      state.chargeableWeight = editDimension.chargeableWeight;
    };
    ...
    const totalChargeableWeight = ref(0);
    ...
    watchEffect(() => {
      ...
      const temp = state.totalVolume / 6000;
      state.chargeableWeight = temp.toFixed(3);
    });
    onMounted(() => {
            ...
            <div>
              ...
              <div v-if="table.length > 0" class="px-4">
                <div class="my-2 mt-4 flex flex-col">
                  <div class="-my-2 overflow-x-auto px-2 sm:-mx-6 lg:-mx-8">
                    <div
                      ...
                      >
                        ...
                        <table>
                          ...
                          <td
                            class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                          >
                            Chargeable Weight: {{ totalChargeableWeight }}
                          </td>
                        </table>
                      </div>
                    </div>
              ...
              >
                <div class="mb-4 grid grid-cols-12 gap-y-4 gap-x-4 border p-3">
                  <div
                ...
                <div class="grid grid-cols-12 gap-y-4 gap-x-4 border p-3">
                  <div
                    class="col-span-12 text-sm font-semibold uppercase tracking-wider text-gray-400"
                  >
                    Total
                  ...
                  <div class="col-span-6 sm:col-span-2">
                    ...
                    <input
                      ...
                      readonly
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      v-model="state.chargeableWeight"
                    />
                    <span
                      v-if="v$.chargeableWeight.$error"
                      class="font-small text-xs text-red-600"
                    >
                      {{ v$.chargeableWeight.$errors[0].$message }}
                    </span>
                  </div>
