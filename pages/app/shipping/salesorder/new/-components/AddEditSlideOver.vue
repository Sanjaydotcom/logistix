...
import Costing from "./Costing.vue";
...
<template>
  <div class="mt-6 flex flex-1 flex-col justify-between">
    <div class="divide-y divide-gray-200 px-4 sm:px-6">
      <div class="grid grid-cols-6 gap-6">
        ...
        <div class="col-span-6 sm:col-span-2">
          <label for="custRefNo" class="block text-sm font-medium text-gray-700"
  ...
  />
  <div class="flex flex-shrink-0 justify-end bg-gray-50 px-1 py-4 mb-3">
    <button
      type="button"
      class="
        rounded-md
