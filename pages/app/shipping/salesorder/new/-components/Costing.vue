<script>
import CostingForm from "./CostingForm.vue";
import Notification from "@/components/ui/Notification.vue";
import { useCustomerStore } from "@/store/crm/customers";
import CostingActions from "./CostingActions.vue";
...
<template>
  <div class="mx-auto max-w-5xl py-2">
    ...
    <button
      v-if="!state.costing.length && !toogleForm"
      type="button"
    ...
    <div class="bg-white pt-2">
      <div
        ...
        v-if="state && state.costing && state.costing.length > 0"
      >
        <table class="min-w-full divide-y divide-gray-300">
          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            <tr v-for="(data, index) in state.costing" :key="data.id">
              <td
    ...
    <div class="ml-4 mt-2 flex justify-end py-2">
      <button
        ...
        v-if="state.costing.length >= 1 && !toogleForm"
        @click="addNewRow"
      >
        <svg
          class="h-5 w-5"
