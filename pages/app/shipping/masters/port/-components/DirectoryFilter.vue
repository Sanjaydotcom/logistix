...
import { usePortStore } from "~~/store/masters/port";
...
<template>
  <div class="relative flex-shrink-0" ref="inner_ref">
    ...
    <div
      v-if="showFilters"
      class="absolute left-0 z-30 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
      role="menu"
    ...
    >
      ...
      >
        ...
        <div
          v-if="showMore"
          class="absolute left-56 -top-4 z-30 mx-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md border border-gray-200 bg-white shadow-lg"
          role="menu"
          aria-orientation="vertical"
          aria-labelledby="menu-1-button"
        >
