...
export default {
  ...
  setup() {
    ...
    const { portUpdated } = storeToRefs(store);
    ...
    const deleteList = async () => {
      ...
      router.push("/app/shipping/masters/port/");
    };
    watch(portUpdated, () => {
      if (portUpdated.value) {
    ...
    const showNextItem = () => {
      router.push(`/app/shipping/masters/port/${Number(state.id) + 1}`);
    };
    const showPrevItem = () => {
      router.push(`/app/shipping/masters/port/${Number(state.id) - 1}`);
    };
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
              <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500">Port Type</dt>
                  <dd class="mt-1 text-sm text-gray-900">
                    {{ state.data.kind }}
                  </dd>
                </div>
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500">Port Code</dt>
                  <dd class="mt-1 text-sm text-gray-900">
                    {{ state.data.code }}
                  </dd>
                </div>
    ...
    >
      <div class="flex h-full items-center justify-center">
        ...
        <div class="text-center">
          ...
          <p class="mt-5 text-sm text-gray-500">Select a Port</p>
        </div>
      </div>
    </section>
    <!-- Message list-->
