...
export default {
  ...
  methods: {
    async submitForm() {
      ...
      if (!this.v$.$error) {
        if (this.id) {
          const EditStatus = await this.store.update(this.state, this.id);
          ...
          const SaveStatus = await this.store.addNew(this.state);
            ...
            >
              <div class="h-0 flex-1 overflow-y-auto">
                ...
                <div class="flex flex-1 flex-col justify-between">
                  ...
                  <ErrorNotification
                    v-if="errorNotificationStatus"
                    message="Commodity Not Saved"
