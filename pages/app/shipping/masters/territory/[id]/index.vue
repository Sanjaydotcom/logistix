...
import useTerritoryStore from "~~/store/masters/territory";
...
export default {
  ...
  setup() {
    ...
    const { territoryUpdated } = storeToRefs(store);
    ...
    const deleteList = async () => {
      ...
      router.push("/app/shipping/masters/territory/");
    };
    watch(territoryUpdated, () => {
      if (territoryUpdated.value) {
    ...
    const showNextItem = () => {
      router.push(`/app/shipping/masters/territory/${Number(state.id) + 1}`);
    };
    const showPrevItem = () => {
      router.push(`/app/shipping/masters/territory/${Number(state.id) - 1}`);
    };
    ...
    >
      <div class="flex h-full items-center justify-center">
        ...
        <div class="text-center">
          ...
          <p class="mt-5 text-sm text-gray-500">Select a Territory</p>
        </div>
      </div>
    </section>
    <!-- Message list-->
