...
export default {
  ...
  setup() {
    ...
    const { costelementUpdated } = storeToRefs(store);
    ...
    const deleteList = async () => {
      ...
      router.push("/app/shipping/masters/costelement/");
    };
    watch(costelementUpdated, () => {
      if (costelementUpdated.value) {
    ...
    const showNextItem = () => {
      router.push(`/app/shipping/masters/costelement/${Number(state.id) + 1}`);
    };
    const showPrevItem = () => {
      router.push(`/app/shipping/masters/costelement/${Number(state.id) - 1}`);
    };
          ...
          <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500">Cost Element Name</dt>
                <dd class="mt-1 text-sm text-gray-900">
                  {{ state.data.name }}
                </dd>
              </div>
              <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500">Cost Element Code</dt>
                <dd class="mt-1 text-sm text-gray-900">
                  {{ state.data.code }}
                </dd>
              </div>
