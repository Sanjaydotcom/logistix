...
import useVesselStore from "~~/store/masters/vessel";
...
export default {
  ...
  setup() {
    ...
    const { vesselUpdated } = storeToRefs(store);
    ...
    const deleteList = async () => {
      ...
      router.push("/app/shipping/masters/vessel/");
    };
    watch(vesselUpdated, () => {
      if (vesselUpdated.value) {
    ...
    const showNextItem = () => {
      router.push(`/app/shipping/masters/vessel/${Number(state.id) + 1}`);
    };
    const showPrevItem = () => {
      router.push(`/app/shipping/masters/vessel/${Number(state.id) - 1}`);
    };
          ...
          <div class="bg-white shadow sm:rounded-lg">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
              <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                ...
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500">Liner</dt>
                  <dd class="mt-1 text-sm text-gray-900">
                    <InputLinerValue
                      v-if="state.data.linerId"
                      :id="state.data.linerId"
                    />
                  </dd>
                </div>
              </dl>
    ...
    >
      <div class="flex h-full items-center justify-center">
        ...
        <div class="text-center">
          ...
          <p class="mt-5 text-sm text-gray-500">Select a Vessel</p>
        </div>
      </div>
    </section>
    <!-- Message list-->
