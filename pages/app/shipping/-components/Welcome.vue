...
import { useMicrosoftGraph } from "@/composables/useMicrosoftGraph";

const stats = [
  { label: "Enquiries pending", value: 2 },
  { label: "Sales order", value: 4 },
  { label: "New Quotation", value: 2 },
];
...
async function getGraphData() {
  ...
  if (inProgress.value === InteractionStatus.None) {
    const graphData = await useMicrosoftGraph(response.accessToken);
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            <div class="sm:flex sm:space-x-5">
              ...
              <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                ...
                <div v-if="state.data.displayName">
                  ...
                  <div v-if="!state.data.displayName">
                <div
                  class="flex h-full animate-pulse flex-col items-center justify-center md:items-start"
                >
                  <div class="my-2 h-6 w-72 rounded-md bg-gray-300" />
                  <div class="h-4 w-56 rounded-md bg-gray-300" />
                </div>
              </div>
              </div>
